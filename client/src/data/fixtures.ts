...
export const calculations: Calculation[] = [
  ...
  { id: "calc-1022", batchId: "BATCH-1022", name: "SS316 Draft", mode: "metal", status: "DRAFT", totalQuantity: "1500", finalCost: "88450", updatedAt: day(1), createdAt: day(1), alloy: alloys[1], user: { name: "Neha Verma" } },
